...
function export_mun(){	
	...
	$result = $this->cnd_imobiliaria_model->listarIptuCsvByCidade($id,$possuiCnd,$situacao);
 ...
 function export_est(){	
	...
	$result = $this->cnd_imobiliaria_model->listarIptuCsvByEstado($id,$possuiCnd,$situacao);
 ...
 function csvGrafico($result){
  ...
  function export(){	
	...
	if($id == 0){
		...
		$result = $this->cnd_imobiliaria_model->listarIptuCsv($idContratante,$possuiCnd,$situacao);
  ...
  function buscaCidadeVig(){	
	$id = $this->input->get('estado');
	$tipo = $this->input->get('tipo');
	$situacao = $this->input->get('situacao');
	
	$retorno ='';
	$result = $this->cnd_imobiliaria_model->listarCidadeByEstadoVig($id,$tipo,$situacao);
 ...
 function buscaCidade(){	
	...
	$retorno ='';
	$result = $this->cnd_imobiliaria_model->listarCidadeByEstado($id,$tipo,$situacao);
 ...
 function buscaInscricaoByEstado(){	
	...
	$retorno ='';
	$result = $this->cnd_imobiliaria_model->listarImovelByEstado($id,$tipo,$situacao);
 ...
 function buscaImovel(){	
	...
	$retorno ='';
	$result = $this->cnd_imobiliaria_model->listarImovelByCidade($id,$tipo,$situacao);
...
function dados_agrupados(){	
	...
	$data['imoveis'] = $this->cnd_imobiliaria_model->listarImovel($idContratante,'X',0);
	
	$data['estados'] = $this->cnd_imobiliaria_model->listarEstado($idContratante,'X',0);
	...
	foreach($situacao as $sit){
		$result = $this->cnd_imobiliaria_model->contaSituacao($idContratante,1,$sit->id);
		$situacaoSim[$i]['situacao'] = $sit->descricao;
		$situacaoSim[$i]['total'] = $result[0]->total;
		$i++;
	}
	// ultimo parametro 1 para vigente, 2 para não vigente
	$data['vigentes'] = $this->cnd_imobiliaria_model->contaVigente($idContratante,1,1);
	//print_r($this->db->last_query());
	$data['naoVigentes'] = $this->cnd_imobiliaria_model->contaVigente($idContratante,1,2);
	//print_r($this->db->last_query());exit;
	
	$i=1;
	foreach($situacao as $sit){
		$result = $this->cnd_imobiliaria_model->contaSituacao($idContratante,2,$sit->id);
	...
	$i=1;
	foreach($situacao as $sit){
		$result = $this->cnd_imobiliaria_model->contaSituacao($idContratante,3,$sit->id);
	...
	$i=1;
	foreach($situacao as $sit){
		$result = $this->cnd_imobiliaria_model->contaSituacao($idContratante,4,$sit->id);
	...
	$data['ano_ref'] =  $ano;
	$data['iptus'] = $this->cnd_imobiliaria_model->contaCnd($idContratante);
 ...
 if(!$_SESSION['loginTeste']){
  ...
  $session_data = $_SESSION['loginTeste'];
	...
	$data['perfil'] = $session_data['perfil'];
	$data['imoveis'] = $this->cnd_imobiliaria_model->listarImovel($idContratante,$tipo,0);
	$data['estados'] = $this->cnd_imobiliaria_model->listarEstado($idContratante,$tipo,0);
	$data['cidades'] = $this->cnd_imobiliaria_model->listarCidade($idContratante,$tipo,0);
	...
	if(empty($_POST)){
		...
		if($idImovelListar == '0'){	
			if($municipioListar <> '0'){
				$result =  $this->cnd_imobiliaria_model->listarCndTipoMun($idContratante,$municipioListar,$tipo,0);
			}else{
				$result =  $this->cnd_imobiliaria_model->listarCndTipoEst($idContratante,$estadoListar,$tipo,0);
			}
		}else{	
 ...
 function listarPorSituacao(){	
	...
	$result =  $this->cnd_imobiliaria_model->listarCndTipoSituacao($idContratante,$situacao,$tipo,0);
	//print_r($this->db->last_query());exit;
	$data['tipo'] = $tipo;
	$data['iptus'] = $result;
	$data['perfil'] = $session_data['perfil'];
 ...
 function listarVigentes(){	
	...
	$data['imoveis'] = $this->cnd_imobiliaria_model->listarImovel($idContratante,1,$situacao);
	$data['estados'] = $this->cnd_imobiliaria_model->listarEstado($idContratante,1,$situacao);
	$data['cidades'] = $this->cnd_imobiliaria_model->listarCidade($idContratante,1,$situacao);
	...
	if(empty($_POST)){
		...
		if($idImovelListar == '0'){	
			if($municipioListar <> '0'){
				$result =  $this->cnd_imobiliaria_model->listarCndTipoMun($idContratante,$municipioListar,1,$situacao);
			}else{
				$result =  $this->cnd_imobiliaria_model->listarCndTipoEst($idContratante,$estadoListar,1,$situacao);
			}
		}else{	
			$result = $this->cnd_imobiliaria_model->listarCndTipoId($idContratante,$idImovelListar,1);
		}
	}
	...
	$this->load->view('header_pages_view',$data);
    $this->load->view('listar_cnd_imobiliaria_vigente_view', $data);
	$this->load->view('footer_pages_view');
