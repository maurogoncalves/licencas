...
//redirect('/iptu/listar', 'refresh');		 
 ...
 function enviar_pend_old(){
		...
		if ( ! $this->upload->do_upload($field_name)){
			...
						$dados = array(			'arquivo_pendencias' => $id.'.'.$extensao,			'usuario_upload' => $session_data['id']);	
