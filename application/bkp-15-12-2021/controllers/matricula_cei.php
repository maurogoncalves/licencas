...
*/	 
 ...
 function editar(){	
 $id = $this->input->get('id');		
 $session_data =  $_SESSION['loginTeste'];	$data['perfil'] = $session_data['perfil'];	
 $session_data =  $_SESSION['loginTeste'];	$idContratante = $session_data['id_contratante'];			
...
$session_data =  $_SESSION['loginTeste'];	$idContratante = $session_data['id_contratante'];			$cei = $this->input->get('cei');	$result = $this->matricula_cei_model->buscaCeiExistente($idContratante,$cei);	$retorno['total'] = $result[0]->total;		echo json_encode($retorno);	  }  
...
function export(){	
	...
	if($id == 0){
		...
		$result = $this->matricula_cei_model->listarTodasCeiExport($idContratante);
	}else{

		$result = $this->matricula_cei_model->listarCeiByCodigo($idContratante,$id);
	}
