...
class Imovel extends CI_Controller {
 ...
 function buscaImovel(){	
	...
	$retorno ='';
	$result = $this->imovel_model->listarImovelByCidade($id);
...
$retorno .=" <tr style='color:$cor;'>";
 ...
 function ativar(){
	...
	$_SESSION["cidadeIMBD"] = $dadosImovel[0]->cidade;
	$_SESSION["estadoIMBD"] = $dadosImovel[0]->estado;
	$_SESSION["idImBD"] = $dadosImovel[0]->id;
 ...
 function listar(){	
	...
	if(empty($_POST)){	
		$data['idImovelBD'] = 0;
		$data['idImovelMunBD'] = 0;
		$data['idImovelUFBD'] = 0;	
		$data['imoveis'] = $this->imovel_model->listarTodosImovel($idContratante);	
