                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Informa&ccedil;&otilde;es da CND </h4>
								...
								echo form_open_multipart('cnd_obras/atualizar_cnd', $attributes); 
								?>		
								 <input type="hidden"  id='id' name='id_cnd' class="form-control" value='<?php echo $imovel[0]->id_cnd;?>'>
								 <input type="hidden"  id='id_cei' name='id_cei' class="form-control" value='<?php echo $imovel[0]->id_cei;?>'>
                                ...
                                <div class="panel-body">
                                 <form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" readonly='yes'  id='id_insc' name='id_insc' class="form-control"  value='<?php echo $imovel[0]->imovel ?>' readonly='yes'>                              
										</div>
										
										<label class="col-lg-2 control-label">Inscri&ccedil;&atilde;o Imobili&aacute;ria</label>
										<div class="col-lg-4">
											 <input type="text" readonly='yes' id='inscricao' name='inscricao' class="form-control" value='<?php echo $imovel[0]->cei;?>'>								
											 <input type="hidden"  id='id' name='id' class="form-control"  value='<?php echo $imovel[0]->id ?>'   >
										</div>
