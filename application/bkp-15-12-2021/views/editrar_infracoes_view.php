                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
									<select name="class_infra" id="class_infra" required="" tabindex="6" class='custom-select' style='width:220px;height:30px'>
										<option value="0">Escolha</option>										 
                                    ...
                                    <div class="col-lg-2">
									<select name="motiv_infracao" id="motiv_infracao" required="" tabindex="7" class='custom-select' style='width:220px;height:30px'>
										<option value="0">Escolha</option>										 
								...
								<div class="form-group">
									...
									<div class="col-lg-10"><input type="text"  id='obs' name='obs'  class="form-control" tabindex="20" value='<?php echo$infracao[0]->obs_infracao ?>'    ></div>
								</div>
