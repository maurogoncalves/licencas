...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var idCNDIBD = $('#idCNDIBD').val();
		$('#estado').val(estadoBD);
		
		if(estadoBD !=='0'){	
			$.ajax({				
					url: "<?php echo $this->config->base_url(); ?>index.php/cnd_imob/buscaCidade?estado=" + estadoBD+"&tipo="+tipo,				
					type : 'GET', /* Tipo da requisição */ 				
					contentType: "application/json; charset=utf-8",	        	
					dataType: 'json', /* Tipo de transmissão */				
						success: function(data){						
			...
			$.ajax({				
				url: "<?php echo $this->config->base_url(); ?>index.php/cnd_imob/buscaInscricaoByEstado?id=" + estadoBD+"&tipo="+tipo,			
				type : 'GET', /* Tipo da requisição */ 				
				contentType: "application/json; charset=utf-8",	        	
				dataType: 'json', /* Tipo de transmissão */				
				success: function(data){						
		...
		if(cidadeBD !=='0'){	
			$.ajax({				
					url: "<?php echo $this->config->base_url(); ?>index.php/cnd_imob/buscaImovel?id=" + cidadeBD+"&tipo="+tipo,						
					type : 'GET', /* Tipo da requisição */ 				
					contentType: "application/json; charset=utf-8",	        	
					dataType: 'json', /* Tipo de transmissão */				
					success: function(data){						
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card ">
                                ...
                                <div class="panel-heading">
									...
									echo form_open('cnd_imob/'.$CNDImob, $attributes); 
									?>
