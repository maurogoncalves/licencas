												 ...
												 <td> <?php echo $emitente->imovel; ?> </td>		
												  ...
												  <td >
													<?php if($emitente->possui_cnd == 3 ){?>
													  ...
													  <a href="<?php echo $this->config->base_url();?>index.php/cnd_obras/excluir?id=<?php echo $emitente->id_cnd; ?>" class="btn btn-danger btn-xs" title='Inativar'><i class="fa fa-trash-o "></i></a>												  </td>							  										
												</tr>
