				  ...
				  <br><br>
                      <div class="content-panel">
                          ...
                          <table id="clientes" class="table table-fixedheader table-striped table-advance table-hover">
                              ...
                              <tbody id='lista'>								<?php 								 								$isArray = is_array($iptus) ? '1' : '0';								if($isArray == 1){								 foreach($iptus as $key => $iptu){ 									 								 if($iptu->possui_cnd == 1){									$possui ='Sim';									$dataVArr = explode("-",$iptu->data_vencto);									 									$dataV = $dataVArr[2].'-'.$dataVArr[1].'-'.$dataVArr[0];								 }elseif($iptu->possui_cnd == 2){									$possui ='Não';									$dataVArr = explode("-",$iptu->data_vencto);									 									$dataV = $dataVArr[2].'-'.$dataVArr[1].'-'.$dataVArr[0];									 }else{									$possui ='Pendência';									$dataVArr = explode("-",$iptu->data_pendencias);									 									$dataV = $dataVArr[2].'-'.$dataVArr[1].'-'.$dataVArr[0];									 }									 									  if($iptu->status_insc == 0){										$status ='Ativo';										$cor = '#009900';									 }else{										$status ='Inativo';										$cor = '#CC0000';									 }									 									 																	 ?>								 <tr style='color:<?php echo $cor; ?>'>                                  <td width="18%"><a href="#"><?php echo $iptu->raz_soc; ?></a></td>								  <td width="14%">								  <?php if($iptu->loja_acomp){ ?>								  <a href="<?php echo $this->config->base_url();?>index.php/acomp_cnd/painel?id=<?php echo $iptu->loja_acomp; ?>">									<?php echo $iptu->cpf_cnpj_loja; ?>								  </a>								  <?php }else{ ?>								  <a style='color:#000' href="<?php echo $this->config->base_url();?>index.php/loja/acomp?id=<?php echo $iptu->id_loja; ?>">									<?php echo $iptu->cpf_cnpj_loja; ?>								  </a>								  <?php } ?>																</td>                                  <td width="14%" class="hidden-phone">								  									<?php 										if( ($iptu->possui_cnd == 1 )) {											if(!empty($iptu->arquivo_cnd)){?>												<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/ver?id=<?php echo $iptu->id_cnd; ?>"><?php echo $iptu->ins_cnd_mob; ?></a>											<?php }else{?>													<?php echo $iptu->ins_cnd_mob; ?>											<?php }										}else{											if(!empty($iptu->arquivo_pendencias)){?>											<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/ver?id=<?php echo $iptu->id_cnd; ?>"><?php echo $iptu->ins_cnd_mob; ?></a>											<?php }else{?>													<?php echo $iptu->ins_cnd_mob; ?>											<?php }} ?>																	  </td>								  <td width="15%" class="hidden-phone"><?php echo $possui; ?></td>								  <td width="24%" class="hidden-phone"><?php echo $dataV; ?></td>			  							                                     <td width="14%">      																		<?php 									if(($iptu->possui_cnd == 3 )){	?>									 <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/upload_pend?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-danger btn-xs" title='Upload de Pendência '><i class="fa fa-upload"></i></a>									  										<?php  }else{ ?>									  <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/upload_cnd?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-success btn-xs" title='Upload de Arquivo'><i class="fa fa-upload"></i></a>									  									<?php  } ?>                                        <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/editar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-primary btn-xs" title='Editar'><i class="fa fa-pencil"></i></a>                                      <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/inativar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-danger btn-xs" title='Inativar' ><i class="fa fa-trash-o "></i></a>									  <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/ativar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-primary btn-xs" title='Ativar'><i class="fa fa-check-square-o"></i></a>                                  </td>								  </tr>								  <?php								  }								  }else{								  								   ?>								 <tr >                                  <td>Não Há Registros</td>                                  <td class="hidden-phone">  </td>								  <td class="hidden-phone"></td>			  								  <td class="hidden-phone"></td>								  <td class="hidden-phone"></td>			  							                                     <td>            									                                    </td>								  </tr>								  <?php								  								  }								  								  ?>
