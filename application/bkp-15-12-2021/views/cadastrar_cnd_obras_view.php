                        ...
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Cadastrar CND Obras <small>	
									...
									?></small></h1>
                                <ol class="breadcrumb">
                                    <li class="active">Cadastrar CND Obras</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"> Informa&ccedil;&otilde;es da CND Obras </h4>
								...
								echo form_open_multipart('cnd_obras/cadastrar_cnd_obras', $attributes); 
								?>		
                                <div class="panel-body">
                                 <form class="form-horizontal">									
									<div class="form-group">
										<label class="col-lg-2 control-label">N&uacute;mero CEI</label>
										<div class="col-lg-4">
										<input type="text" readonly='yes' id='cei' name='cei' class="form-control" value='<?php echo $dados_cei[0]->cei;?>'>
										<input type="hidden"  id='id' name='id' class="form-control" value='<?php echo $dados_cei[0]->id_cei;?>'> 
									...
									<div class="form-group">
										<label class="col-lg-2 control-label" id='data_emissao'>Data de Emissão</label>
										<div class="col-lg-8">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label" id='data_vecto_cnd'>Data Vencimento</label>
										<div class="col-lg-8">
