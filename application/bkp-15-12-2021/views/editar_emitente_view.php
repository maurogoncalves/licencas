                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Editar Emitente<small></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo $this->config->base_url();?>index.php/emitente/listar"><i class="fa fa-home"></i>Listar Emitente</a></li>
                                    <li class="active">Editar Emitente</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                            ...
                            <div class="panel panel-card margin-b-30">
                                ...
                                <div class="form-group" id='cnpj_div'>
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div>
										<?php 										
										if( $emitentes[0]->matriz_filial==2){ ?>
