...
$(document).ready(function(){
	...
	$( "#municipio" ).change(function() {		
		...
		$.ajax({				
			url: "<?php echo $this->config->base_url(); ?>index.php/cnd_mob/buscaLojaByCidadeEstado?id=" + municipio+"&tipo="+tipo+"&uf="+uf,				
			type : 'GET', /* Tipo da requisição */ 				
			contentType: "application/json; charset=utf-8",	        	
			dataType: 'json', /* Tipo de transmissão */				
			success: function(data){						
	...
	if(estadoBD !=='0'){
		$.ajax({				
				url: "<?php echo $this->config->base_url(); ?>index.php/cnd_mob/buscaCidade?estado=" + estadoBD+"&tipo="+tipo,						
				type : 'GET', /* Tipo da requisição */ 				
				contentType: "application/json; charset=utf-8",	        	
				dataType: 'json', /* Tipo de transmissão */				
				success: function(data){						
		...
		$.ajax({				
			url: "<?php echo $this->config->base_url(); ?>index.php/cnd_mob/buscaInscricaoByEstado?id=" + estadoBD+"&tipo="+tipo,				
			type : 'GET', /* Tipo da requisição */ 				
			contentType: "application/json; charset=utf-8",	        	
			dataType: 'json', /* Tipo de transmissão */				
			success: function(data){						
	...
	if(cidadeBD !=='0'){
		...
		$.ajax({				
			url: "<?php echo $this->config->base_url(); ?>index.php/cnd_mob/buscaLoja?id=" + cidadeBD+"&tipo="+tipo,				
			type : 'GET', /* Tipo da requisição */ 				
			contentType: "application/json; charset=utf-8",	        	
			dataType: 'json', /* Tipo de transmissão */				
			success: function(data){						
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>CND Mobiliária <small>	<?php echo utf8_encode($mensagemCNDMOB);?></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/dados_agrupados"><i class="fa fa-home"></i></a></li>
                                    <li class="active">Lista de CND Mobiliária</li>
                                    ...
                                    <table id="basic-datatables" class="table table-bordered" cellspacing="0" width="100%">
										...
										<?php 	
											 ...
											 ?>
												...
												<td > 
													<?php if( ($iptu->possui_cnd <> 3 )) {?>										
														<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/upload_cnd?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-success btn-xs" title='Upload de CND'><i class="fa fa-upload"></i></a>									  										
													<?php }else{?>											
														<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/upload_pend?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-danger btn-xs" title='Upload de Pendência'><i class="fa fa-upload"></i></a>									  										 
													<?php }?>                                      
													<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/editar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-primary btn-xs" title='Editar'><i class="fa fa-pencil"></i></a>                                      
													<?php if($visitante == 0){ ?>
																
																<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/inativar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-danger btn-xs" title='Inativar'><i class="fa fa-trash-o "></i></a>									  
																<a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/ativar?id=<?php echo $iptu->id_cnd; ?>" class="btn btn-primary btn-xs" title='Ativar'><i class="fa fa-check-square-o"></i></a>                                  
														<?php } ?>		
												</td>								  										
												</tr>
