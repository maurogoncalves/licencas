                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Imóveis <small>	<?php if(!empty($_SESSION['mensagemImovel'])){echo utf8_encode($_SESSION['mensagemImovel']);}?></small></h1>
                                <ol class="breadcrumb">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card ">
                                ...
                                <div class="panel-heading">
									...
									<?php foreach($select_imoveis as $key => $im){ ?>					 
								...
								<?php 	
									 ...
									 ?>
									  <tr>
									  <td><?php echo substr($emitente->nome,0,45); ?></td>
									  <td><?php echo $emitente->descricao; ?></td>
									  <td><?php echo $emitente->area_total; ?></td>
									  <td><?php echo $combo; ?></td>
									  <td>
										<a href="<?php echo $this->config->base_url();?>index.php/imovel/emitente_imovel?id=<?php echo $emitente->id; ?>" class="btn btn-success btn-xs" title='Emitentes'><i class="fa fa-bars"></i></a>									  
										...
										<a href="<?php echo $this->config->base_url();?>index.php/imovel/ativar?id=<?php echo $emitente->id; ?>" class="btn btn-success btn-xs" alt='Ativar' title='Ativar' ><i class="fa fa-check "></i></a>
										
										<a href="<?php echo $this->config->base_url();?>index.php/imovel/excluir?id=<?php echo $emitente->id; ?>" class="btn btn-danger btn-xs" title='Inativar'><i class="fa fa-trash-o "></i></a>
										<?php } ?>
									  </td>
									  </tr>
									  <?php
