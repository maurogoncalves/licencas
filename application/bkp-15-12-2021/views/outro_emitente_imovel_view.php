					...
					<?php									
						...
						<div class="form-group">										
							<label class="col-lg-2 control-label">&Aacute;rea Total (Mt)</label>										
								...
								<div class="form-group"><label class="col-sm-2 control-label">Escolher Emitente</label>										
								<div class="col-lg-10">										  
								...
								<div class="form-group"><label class="col-sm-2 control-label">&Aacute;rea do Emitente (%)</label>										
								<div class="col-lg-10">										  
								<input type="text" id='areaDestinada' name='areaDestinada' class="form-control" value='100' maxlength='6'  >										
								</div>									
								</div>																											
