				  ...
				  <span class='pull-right' style='font-weight:bold'>
                      ...
                      <div class="form-panel">
							 ...
							 <?php
								...
								echo form_open_multipart('cnd_obras/enviar_pend', $attributes); 
							 ?>							 <div class="form-group">                              <label class="col-sm-2 col-sm-2 control-label">N&uacute;mero Cei</label>                              <div class="col-sm-4">								<input type="text"  id='nome' readonly='yes' name='nome' class="form-control" value=' <?php echo $imovel[0]->cei?>'   >                                								<input type="hidden"  id='id' name='id' class="form-control" value='<?php echo $imovel[0]->id_cnd?>'   >                                                                </div>							                                <label class="col-sm-2 col-sm-2 control-label">Ano Refer&ecirc;ncia</label>                              <div class="col-sm-4">								<input type="text"  id='nome' readonly='yes' name='nome' class="form-control" value=' <?php echo $imovel[0]->data_abertura?>'   >                                                              </div>							</div>																										 <div class="form-group">							                                <div class="col-sm-4">								Upload CND (apenas pdf)								<input type="file" name="userfile" size="40">                              </div>							</div>								
