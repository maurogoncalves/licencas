                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Editar Infra&ccedil;&atilde;o<small></small></h1>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Editar Infra&ccedil;&atilde;o</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- end .page title-->
                    ...
                    <div class="row">                       
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
								...
								echo form_open('infracoes/editar_infracao', $attributes); 
								?>
                                    ...
                                    <div class="col-lg-4">
										<select name="id_estado" id="id_estado" required=""  class='custom-select' style='width:350px;height:30px'>
											...
											<?php foreach($estados as $key => $estado){ 
												if ($infracao[0]->estado == $estado->estado){
											?>									 
                                    ...
                                    <div class="col-lg-4">
										<select name="id_cidade" id="id_cidade" required=""  class='custom-select' style='width:350px;height:30px'>	
											...
											<?php foreach($cidades as $key => $cidade){ 
												if ($infracao[0]->cidade == $cidade->cidade){
												?>									  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                      	<input type="text" readonly='yes' name='cnpj' id='cnpj' class="form-control"  required="" value='<?php echo$infracao[0]->cpf_cnpj ?>'> 
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                      	<input type="text" readonly='yes'  id='codloja' name='codloja' class="form-control" required=""   value='<?php echo$infracao[0]->cod1 ?>'    >
                                    </div>									
									<label class="col-sm-2 control-label">Bandeira</label>
                                    <div class="col-lg-2">
                                      	<input type="text" readonly='yes' id='bandeira' name='bandeira' class="form-control" required=""  value='<?php echo$infracao[0]->bandeira ?>'  >
                                    </div>		
									<label class="col-lg-2 control-label">Regional</label>
                                    <div class="col-lg-2">
									<input type="text" readonly='yes' id='regional' name='regional' class="form-control" required="" value='<?php echo$infracao[0]->regional ?>'    >
                                    </div>									
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
									<input type="text"  id='infracao' name='infracao' class="form-control" tabindex="5" value='<?php echo$infracao[0]->cod_infracao ?>'  >
                                    </div>
									...
									<select name="tipo_auto" id="tipo_auto" required="" tabindex="6" class='custom-select' style='width:160px;height:30px'>
										<option value="0">Escolha</option>										 
											...
											if ($infracao[0]->id_auto == $tipoAuto->id){	
											?>	
											<option value="<?php echo $tipoAuto->id ?>" selected><?php echo $tipoAuto->descricao?></option>		
											<?php }else{ ?>	
								  ...
								  <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
									<select name="motiv_infracao" id="motiv_infracao" required="" tabindex="7" class='custom-select' >
										<option value="0">Escolha</option>										 
											<?php foreach($motivoInfra as $key => $motivo){ 	
												if ($infracao[0]->motivo_infracao == $motivo->id){	?>
												<option value="<?php echo $motivo->id ?>" selected><?php echo $motivo->descricao?></option>	
												<?php }else{ ?>		
									...
									<label class="col-lg-2 control-label">Classifica&ccedil;&atilde;o da Infra&ccedil;&atilde;o</label>
                                    <div class="col-lg-4">
									<select name="class_infra" id="class_infra" required="" tabindex="7" class='custom-select' >
										<option value="0">Escolha</option>										 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10"><input type="text"  id='breve_relato' name='breve_relato' tabindex="8" class="form-control" value='<?php echo$infracao[0]->relato_infracao ?>'     >
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-lg-2">
									<input type="text" data-masked="" data-inputmask="'mask': '99/99/9999' " id='dt_receb_infra' name='dt_receb_infra' tabindex="9" class="form-control"  value='<?php echo$infracao[0]->data_recebimento_br ?>'  >
                                    </div>
									<label class="col-lg-2 control-label">Compet&ecirc;ncia Inicio </label>
                                    <div class="col-lg-2">
									<input type="text" data-masked="" data-inputmask="'mask': '99/9999' " id='dt_ini_comp' required="" name='dt_ini_comp' tabindex="10" class="form-control" required="" value='<?php echo$infracao[0]->dt_ini_competencia ?>'   >
                                    </div>
									<label class="col-lg-2 control-label">Compet&ecirc;ncia Fim</label>
                                    <div class="col-lg-2">
									<input type="text" data-masked="" data-inputmask="'mask': '99/9999' " id='dt_fim_comp' required="" name='dt_fim_comp' tabindex="11" class="form-control" required=""  value='<?php echo$infracao[0]->dt_fim_competencia ?>'  >
                                    </div>
                                </div>
								
								<div class="form-group">
									<label class="col-lg-2 control-label">Valor Principal</label>
                                    <div class="col-lg-2"><input type="text"  id='valor_principal' data-a-dec="," data-a-sep="." tabindex="12" name='valor_principal' class="auto  form-control" required=""  value='<?php echo$infracao[0]->valor_principal ?>'  >  
                                    </div>
									<label class="col-lg-2 control-label">Atualiza&ccedil;&atilde;o Monet&aacute;ria </label>
                                    <div class="col-lg-2"><input type="text"  id='atualizacao_monetaria' data-a-dec="," data-a-sep="."  tabindex="13" name='atualizacao_monetaria' class="auto  form-control" required="" value='<?php echo$infracao[0]->atualizacao_monetaria ?>'  >
                                    </div>
									
									<label class="col-lg-2 control-label">Multa</label>
                                    <div class="col-lg-2"><input type="text"  id='multa' name='multa' data-a-dec="," data-a-sep="." tabindex="14" class="auto  form-control" required="" value='<?php echo$infracao[0]->multa ?>'   >
								...
								<div class="form-group">
									...
									<div class="col-lg-2">
										<input type="text"  id='juros' name='juros' data-a-dec="," data-a-sep="." tabindex="15" class="auto form-control" required="" value='<?php echo$infracao[0]->juros ?>'  >
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-lg-2"><input type="text"  id='total' name='total' readonly='yes' class="form-control" required=""  value='<?php echo$infracao[0]->total ?>'  > </div>
									
									<label class="col-lg-2 control-label">Valor Total Revisado </label>
                                    <div class="col-lg-2"><input type="text"  id='total' name='total_revisado' tabindex="16" data-a-dec="," data-a-sep="."  class="auto form-control" placeholder=<?php echo$infracao[0]->valor_total_revisao ?>    ></div>

									<label class="col-lg-2 control-label">Valor Efetivo Pago </label>
                                    <div class="col-lg-2"><input type="text"  id='valor_efetivo_pago' data-a-dec="," data-a-sep="." tabindex="17" name='valor_efetivo_pago' class="auto form-control" placeholder='<?php echo$infracao[0]->valor_real_pago ?>'   ></div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">Data planejada fim processo</label>
									<div class="col-lg-2"><input type="text" data-masked="" data-inputmask="'mask': '99/99/9999' " id='dt_plan_fim' name='dt_plan_fim' tabindex="18" class="form-control"  value='<?php echo$infracao[0]->data_plan_fim_processo_br ?>'  ></div>
									<label class="col-lg-2 control-label">Data de encerramento efetivo</label>
									<div class="col-lg-2"><input type="text" data-masked="" data-inputmask="'mask': '99/99/9999' " id='dt_encer_efetivo' name='dt_encer_efetivo' tabindex="19" class="form-control"  value='<?php echo$infracao[0]->data_encerramento_real_br ?>'  ></div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">Observa&ccedil;&otilde;es</label>
									<div class="col-lg-10"><input type="text"  id='obs' name='obs'  class="form-control" tabindex="20" placeholder='Nova Observa&ccedil;&atilde;o'    ></div>
								</div>
								<div class="form-group">
									
									<label class="col-lg-2 control-label">Hist&oacute;rico : Observa&ccedil;&otilde;es</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
										...
										<?php if($visitante == 0){ ?>
											<input type="hidden"  id='id_infracao' name='id_infracao'  class="form-control"  value='<?php echo$infracao[0]->id_infracao ?>'    >
