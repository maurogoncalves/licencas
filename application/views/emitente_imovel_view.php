                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Emitentes Associados <small>	<?php if(!empty($_SESSION['mensagemImovel'])){echo utf8_encode($_SESSION['mensagemImovel']);}?></small></h1>
                                <ol class="breadcrumb">
                                    <li><a href="<?php echo $this->config->base_url();?>index.php/imovel/listar"><i class="fa fa-home"></i> Listar Imóvel</a></li>
                                    <li class="active">Vincular Emitente ao Imóvel</li>
                                </ol>
                            </div>
							<br>
								<?php if($soma < 100){ ?>
									<?php if($visitante == 0){ ?>
										<a  href="<?php echo $this->config->base_url();?>index.php/imovel/outro_emitente_imovel?id=<?php echo $imovel[0]->id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Inserir Emitente Nesse Im&oacute;vel</a>
									<?php } ?>
								<?php }else{ ?>
									<h5>Não é possivel vincular outro emitente ao imóvel, porque a soma das áreas chegou a 100%</h5>									
								<?php } ?>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
								...
								<div class="hr-line-dashed"></div>
								 ...
								 <h4 class="panel-title"> Lista dos Emitentes Associados</h4>
                                </div>
