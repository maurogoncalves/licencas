					...
					if($isArray == 1){								
						...
						?>
                            <div class="price-box">
                                ...
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=<?php echo $iptu->possui_cnd ?>&reg=1"  >  WMBR : <?php echo  $WMBR ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=<?php echo $iptu->possui_cnd ?>&reg=2"  >  BPBA : <?php echo  $BPBA ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=<?php echo $iptu->possui_cnd ?>&reg=3"  >  BPNE : <?php echo $BPNE ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=<?php echo $iptu->possui_cnd ?>&reg=4"  >  WMS : <?php echo $WMS ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=<?php echo $iptu->possui_cnd ?>&reg=5"  > TB : <?php echo $TB ?></li>
                        ...
                        <div class="col-sm-2 margin-b-20">
                            <div class="price-box">
								...
								<h3>Regionais</h3>
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=5&reg=1"  >  WMBR : <?php echo  $regionalTodos[1]['total'] ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=5&reg=2"  >  BPBA : <?php echo  $regionalTodos[2]['total'] ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=5&reg=3"  >  BPNE : <?php echo  $regionalTodos[3]['total'] ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=5&reg=4"  >  WMS : <?php echo  $regionalTodos[4]['total'] ?></li>
									<li><i class="fa fa-cogs"></i> <a href="<?php echo $this->config->base_url();?>index.php/cnd_mob/listarPorRegional?tipo=5&reg=5"  > TB : <?php echo  $regionalTodos[5]['total'] ?></li>
