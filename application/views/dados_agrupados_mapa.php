...
<div id="wrapper">
				...
				<div class="row">
                   ...
                   <div class="row">
						<div class="col-md-12">
							<div class="col-md-3" style='text-align:left;font-weight:bold'>
								...
								<tbody>
									<tr >
										<th colspan=3 
										style='line-height:12px!important;text-align:CENTER;background-color:#002060;color:#fff!important;vertical-align:middle;font-weight:bold'>Licenças por estado
										</th>
									</tr>
									<?php foreach($licencasEstados as $val){?>
									<tr >
										<th  style='line-height:10px!important;text-align:right;font-weight:bold;vertical-align:middle'> <?php echo $val->estado?></th>
					...
					<form  id='formMapa' action='<?php echo $this->config->base_url(); ?>index.php/home/mapa' method='post'>	
						...
						<div class="col-md-12">
							<div class="col-md-12">
								...
								<table id="basic-datatables" class="table table-bordered table-striped " cellspacing="0" width="100%" style='font-size:12px;'>
									...
									<td style='width:45%!important;text-align:center;border:1px solid #002060;'>Tipo de Licença</td>
									...
									foreach($todasCnds as $res){	
										...
										$linkTratativas = "<a style='color:inherit;' href=".$base."index.php/licencas/visao_interna_cnd_mob?id=".$res->id." target='_blank'>  Link para Licenças</a>";																					
										...
										<td style='text-align:center;border:1px solid #002060;font-weight:bold!important'>".$res->ano_vencto ."</td>
