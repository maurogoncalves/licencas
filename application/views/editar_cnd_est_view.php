                        ...
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1>Editar CND Estadual <small>	
									<?php 				  
										if(!empty($_SESSION['msgCNDEst'])){ 						
											echo utf8_encode($_SESSION['msgCNDEst']);				  
										} 
									?></small></h1>
                                <ol class="breadcrumb">
                    ...
                    <div class="row">                       
                        <div class="col-md-12">
                            <div class="panel panel-card margin-b-30">
								...
								echo form_open_multipart('cnd_est/atualizar_cnd', $attributes); 
								?>		
                                 ...
                                 <form class="form-horizontal">
									<div class="form-group">
										...
										<?php if($imovel[0]->possui_cnd == 1){ ?>									
											<a style='color:#ff0000' href="<?php echo $this->config->base_url();?>index.php/cnd_est/upload_cnd?id=<?php echo $imovel[0]->id_cnd; ?>">	Fazer Upload da CND	</a>								
										 <?php }elseif($imovel[0]->possui_cnd == 2){ ?>
											<a style='color:#ff0000' href="<?php echo $this->config->base_url();?>index.php/cnd_est/upload_cnd?id=<?php echo $imovel[0]->id_cnd; ?>"> Fazer Upload da CND	</a>								 
										 <?php }else{ ?>								   	
											<a style='color:#ff0000' href="<?php echo $this->config->base_url();?>index.php/cnd_est/upload_pend?id=<?php echo $imovel[0]->id_cnd; ?>">	Fazer Upload de Pendência  </a>								
										 <?php } ?>			
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
										 <?php 
											  if($imovel[0]->data_emissao){ 
										  ?>								  
											<input type='text' id='data_emissao' name='data_emissao' class='form-control' data-masked="" data-inputmask="'mask': '99/99/9999' " value='<?php echo $imovel[0]->data_emissao ?>'  >
										 <?php 
											  }else{ 
										  ?>	
