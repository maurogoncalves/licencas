                ...
                <div class="sidebar-collapse nano">
                    <div class="nano-content">
                        <ul class="nav metismenu" id="side-menu">
                            ...
                            </li>														 <li id=''>								<a href='#'><i class="fa fa-home" aria-hidden="true"></i> <span class='nav-label'>Dados cadastrais </span><span class='fa arrow'></span></a> 								<ul class="nav nav-second-level collapse">																		<li><a href="<?php echo $base?>/imovel/limpar_filtro" >Imóvel</a></li>									<li><a href="<?php echo $base?>/loja/limpar_filtro" >Loja</a></li>									<!--									<li><a href="<?php echo $base?>/cnd_brasil/cnd_est_criar" >Criar Inscrição Estadual</a></li>									-->									<li><a href="<?php echo $base?>/emitente/listar" >Emitente</a></li>									<li><a href="<?php echo $base?>/usuarios/listar" >Usuários</a></li>								</ul>							</li>                        																					<li id='cnd'>							                                <a href="#"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">CND </span><span class="fa arrow"></span></a>                                <ul class="nav nav-second-level collapse">									<!--									 <li><a href="<?php echo $base?>/cnd_brasil/mapa_geral" style='font-weight:bold!important'>Status Mapa - Geral</a></li>									                                     <li>                                        <a href="#" style='font-weight:bold!important'>Federal <span class="fa arrow"></span></a>                                        <ul class="nav nav-third-level collapse">																						<li>                                                <a href="<?php echo $base?>/cnd_brasil/cnd_fed_lista">&nbsp;Gestão </a>                                            </li>																						                                        </ul>                                    </li>									-->									<!--									 <li>                                        <a href="#" style='font-weight:bold!important'>Estadual <span class="fa arrow"></span></a>                                        <ul class="nav nav-third-level collapse">                                             <li>                                                <a href="<?php echo $base?>/cnd_brasil/cnd_est_mapa">&nbsp;Status Mapa </a>                                            </li>											<li>                                                <a href="<?php echo $base?>/cnd_brasil/cnd_est_lista">&nbsp;Cnd's Ativas </a>												<a href="<?php echo $base?>/cnd_brasil/cnd_est_lista_inativa">&nbsp;Cnd's Inativas </a>                                            </li>											                                        </ul>                                    </li>									-->									 <li>                                        <a href="#" style='font-weight:bold!important'>Mobiliária <span class="fa arrow"></span></a>                                       <ul class="nav nav-third-level collapse">											<!--                                             <li>                                                <a href="<?php echo $base?>/cnd_brasil/cnd_mob_mapa">&nbsp;Status Mapa </a>                                            </li>											-->																						<li>                                                <a href="<?php echo $base?>/cnd_brasil/limpar_filtro">&nbsp;Inscrições Ativas </a>												<a href="<?php echo $base?>/cnd_brasil/cnd_mobiliaria_lista_inativa">&nbsp;Inscrições Inativas </a>                                            </li>																																	<li>                                                												<a href="<?php echo $base?>/cnd_brasil/listar_pendencia">&nbsp;Relatório Pendências </a>												<a href="<?php echo $base?>/cnd_brasil/listar_chamados">&nbsp;Chamados </a>												                                            </li>                                        </ul>                                    </li>									                                </ul>                            </li>
