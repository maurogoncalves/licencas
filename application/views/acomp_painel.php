...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$('#table').hide();   
	var esfera = <?php echo $esfera;?>	
	//alert(esfera);
	$.ajax({
				url: "<?php echo $this->config->base_url(); ?>index.php/acomp_cnd/buscaDados?estado=csp"+"&esfera=1",
	...
	$(".estado").click(function(){	
		...
		$.ajax({
				url: "<?php echo $this->config->base_url(); ?>index.php/acomp_cnd/buscaDados?estado=" + estado+"&esfera="+esfera,
				type : 'GET', /* Tipo da requisição */ 
				contentType: "application/json; charset=utf-8",
	        	dataType: 'json', /* Tipo de transmissão */
				success: function(data){	
...
#tudo2 {
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
	...
	<div id='tudo'>
		...
		<a  href="<?php echo $this->config->base_url();?>index.php/acomp_cnd/painel?esfera=1" class="btn-primary btn-xs"><i class="fa fa-pencil"></i> Esfera Municipal</a>
		&nbsp;
		<a  href="<?php echo $this->config->base_url();?>index.php/acomp_cnd/painel?esfera=2" class="btn-primary btn-xs"><i class="fa fa-pencil"></i> Esfera Estadual</a>
		&nbsp;
		<a  href="<?php echo $this->config->base_url();?>index.php/acomp_cnd/painel?esfera=3" class="btn-primary btn-xs"><i class="fa fa-pencil"></i> Esfera Federal</a>
		&nbsp;
		</p>
		<br><BR>
		<div id='tudo1' >
